    ...
    render() {
        return (
            <div className="PrivacyPolicy">
                ...
                <p>
                    Sage's Sky ("us", "we", or "our") operates the Sage's Sky
                ...
                <p>Sage's Sky uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>
                    Sage's Sky will take all steps reasonably necessary to
                ...
                <p>
                    Sage's Sky may disclose your Personal Data in the good faith
                    belief that such action is necessary to:
                </p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>
                        To protect and defend the rights or property of Sage's
                        Sky
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: crazyandcoding@gmail.com</li>
                </ul>
            </div>
        );
    }
